...
import com.mickael.go4lunch.ui.map.fragment.RestaurantFragment.OnListFragmentInteractionListener;
...
public class MyRestaurantRecyclerViewAdapter extends RecyclerView.Adapter<MyRestaurantRecyclerViewAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            super(view);
            mView = view;
            mIdView = (TextView) view.findViewById(R.id.item_number); // TODO: Changer avec Butterknife
            mContentView = (TextView) view.findViewById(R.id.content); // TODO: Changer avec Butterknife
        }
